...
class TestOddOccurrencesInArray(TestCase):
    def test_solution(self):
        ...
        self.assertEqual(solution([1, 3, 3, 3, 3, 3, 1]), 3)
        ...
        self.assertEqual(solution([1, 1, 1, 1, 1, 9, 9]), 1)
        self.assertEqual(solution([1, 1, 1, 1, 1000000000, 1000000000, 1000000000]), 1000000000)
